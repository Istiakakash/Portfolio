...
export const EDUCATION = [
  ...
  },
  {
    ...
    details: ["Undergrad Research Project: Risk Assessment of Selective Additives in Processed Food Samples Collected from Selected Area."]
  }
];
...
export const TEACHING_EXPERIENCE = [
  {
    ...
    description: "Delivered theoretical lectures for undergraduate courses, developed course materials, and assessed student performance."
  },
  {
    ...
    description: "Assisted in conducting laboratory sessions for undergraduate students, demonstrating instrumentation techniques (HPLC, Spectrophotometry)."
  },
  {
...
export const LEADERSHIP = [
  {
    ...
    period: "2022 – 2024",
    description: "Increased membership 40% and organized 10+ club related programs."
  },
  {
    role: "Assistant Organizing Secretary",
    organization: "BAU Nutrition Club",
    period: "2019 – 2023",
    description: "Coordinated public health campaigns reaching 500+ participants."
  },
  {
    role: "Volunteer Project Lead",
    organization: "Volunteer for Bangladesh (JAAGO Foundation)",
    period: "2019 – 2022",
    description: "Led community service initiatives."
  }
];

// --- UPDATED PUBLICATIONS LIST (All 9 Items) ---
export const PUBLICATIONS = [
  ...
  {
    id: 3,
    authors: "Rafi, K. N., Aziz, M. G., Islam, M. A., Akash, S. I., ...",
    year: "2025",
    ...
    link: "https://doi.org/10.1038/s41598-024-67856-3",
    type: "Journal Article"
  },
  {
    id: 4,
  ...
  },
  {
    ...
    year: "2023",
    title: "Evaluation of the physicochemical qualities and antioxidant properties of some Bangladeshi varieties of honey",
  ...
  },
  {
    ...
    journal: "Dietary Supplements and Nutraceuticals. Springer",
    link: "#",
    type: "Book Chapter"
  }
];

export const RESEARCH_GALLERY = [
  {
    id: 1,
    imageUrl: "https://images.unsplash.com/photo-1579165466741-7f35a4755657?auto=format&fit=crop&q=80&w=800",
    title: "Laboratory Analysis",
    description: "Conducting high-performance liquid chromatography (HPLC) analysis."
  },
  {
    id: 2,
    imageUrl: "https://images.unsplash.com/photo-1581093458791-9f3c3900df4b?auto=format&fit=crop&q=80&w=800",
    title: "Sample Preparation",
    description: "Processing of cashew apple agro-waste for bioethanol production."
  }
];
